            ...
            <section class="bg-white  min-h-[91vh] flex items-center">
                <div class="grid max-w-screen-xl px-4  py-32 md:py-16 sm:py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                    <div class="mr-auto place-self-center lg:col-span-7">
                        <h1 class="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl ">AI powered talent
                            assessment platform</h1>
                        <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl ">Recruiting is complex, time-consuming, and risky. Take the stress out of finding the best candidates with deep analysis that’s accurate, automated, and unbiased. Make hiring exciting again.</p>
